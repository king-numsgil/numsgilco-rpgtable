...
CREATE TABLE IF NOT EXISTS "mystery" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar NOT NULL);
CREATE UNIQUE INDEX "IDX_770278b12b6082924899034884" ON "mystery" ("name") ;
CREATE TABLE IF NOT EXISTS "mystery_spell" ("id" varchar PRIMARY KEY NOT NULL, "class_level" integer NOT NULL, "note" varchar, "spellId" varchar, "mysteryId" varchar, CONSTRAINT "FK_231bb65405a4891a4a92f0ab1cf" FOREIGN KEY ("spellId") REFERENCES "spell" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_aaa4c86e9ce21b47a35e2e64e8c" FOREIGN KEY ("mysteryId") REFERENCES "mystery" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION);
CREATE TABLE IF NOT EXISTS "deity_mysteries_mystery" ("deityId" varchar NOT NULL, "mysteryId" varchar NOT NULL, CONSTRAINT "FK_d983dd0414e41f7bbb2d72eb628" FOREIGN KEY ("deityId") REFERENCES "deity" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_9ee01c790314c998042c3bff730" FOREIGN KEY ("mysteryId") REFERENCES "mystery" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, PRIMARY KEY ("deityId", "mysteryId"));
CREATE INDEX "IDX_d983dd0414e41f7bbb2d72eb62" ON "deity_mysteries_mystery" ("deityId") ;
CREATE INDEX "IDX_9ee01c790314c998042c3bff73" ON "deity_mysteries_mystery" ("mysteryId") ;
